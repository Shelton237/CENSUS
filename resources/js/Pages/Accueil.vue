...
// Données de la galerie photo du terrain (Enrichie & Double-Axe)
    ...
    <MainLayout>
        ...
        <section class="field-gallery-section" id="galerie-terrain">
            <div class="container mx-auto px-4 md:px-6">
                ...
                <div class="bg-white/70 backdrop-blur-md rounded-[32px] p-6 md:p-8 border border-[#E5E9E7] shadow-[0_20px_40px_rgba(32,65,56,0.02)] max-w-5xl mx-auto mb-12">
                    <!-- Axe 1: Activités -->
                    <div class="mb-6">
                        <span class="block text-xs font-bold text-gray-400 uppercase tracking-widest mb-3 text-center md:text-left">
                        ...
                        <div class="flex flex-wrap justify-center md:justify-start gap-2.5">
                            <button 
                                ...
                                :key="tab.id"
                                @click="activeActivityTab = tab.id; visiblePhotosCount = 6;"
                    ...
                    <div>
                        ...
                        <div class="flex flex-wrap justify-center md:justify-start gap-2.5">
                            <button 
                                ...
                                :key="tab.id"
                                @click="activeRegionTab = tab.id; visiblePhotosCount = 6;"
                                class="px-5 py-2.5 rounded-full text-xs md:text-sm font-extrabold transition-all duration-300 border flex items-center gap-2"
