                ...
                <div class="container main-bar-inner">
                    ...
                    <nav class="main-nav" :class="{ 'active': isMenuOpen }" id="main-nav">
                        <ul>
                            ...
                            <li><Link href="/communication" class="nav-link" :class="{ active: $page.component === 'Communication' }">{{ __('Communication') }}</Link></li>
                            <li><Link href="/candidature" class="nav-link" :class="{ active: $page.component === 'Candidature' }">{{ __('Recrutement') }}</Link></li>
