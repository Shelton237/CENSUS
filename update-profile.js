...
const UpdateProfile = () => {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      notifySuccess(t('profile_updated_successfully'));
  ...
  return (
    <Dashboard
      ...
      description={t('edit_profile_desc')}
                      ...
                      {loading ? (
                        ...
                        >
                          <img
                            ...
                            height={10}
                          />
                          <span className="font-serif ml-2 font-light">{t('processing_btn')}</span>
                        </button>
                      ) : (
                        <button
                          disabled={loading}
